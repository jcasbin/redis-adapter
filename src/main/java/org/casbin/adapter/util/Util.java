...
package org.casbin.adapter.util;
...
public class Util {
    ...
    private static Logger LOGGER = LoggerFactory.getLogger("org.casbin.adapter");
     ...
     * @param v the log.
     */
    public static void logPrintf(String format, Object... v) {
        if (enableLog) {
